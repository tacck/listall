                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('htn_webhook_token') ? ' has-error' : '' }}">
                                <label for="htn_webhook_token" class="col-md-4 control-label">Hatena WebHook
                                    Token</label>

                                <div class="col-md-6">
                                    <input id="htn_webhook_token" type="text" class="form-control"
                                           name="htn_webhook_token" value="{{ old('htn_webhook_token') }}" required
                                           autofocus>
